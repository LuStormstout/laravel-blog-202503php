...
'users.update','users.destroy','storage.local',);
        registerArgumentsSet('views', 
'layouts._footer','layouts._header','layouts.default','shared._user_info','static_pages.about',
'static_pages.help','static_pages.home','users.create','users.show','laravel-exceptions-renderer::components.card',
